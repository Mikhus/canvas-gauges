...
else"updateValueOnAnimation"===e&&(d="true"===d?!0:!1);c[e]=d}}c=new Gauge(c);r.getAttribute("data-value")&&c.setRawValue(parseFloat(r.getAttribute("data-value")));r.getAttribute("data-onready")&&(c.onready=function(){eval(this.config.renderTo.getAttribute("data-onready"))});c.draw()}});window.Gauge=Gauge;
